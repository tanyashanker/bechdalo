...
<script src="js/jquery.uls.core.js"></script>
    ...
    <script src="js/easyResponsiveTabs.js"></script><style>
   ...
   <!--  <div id="header">
	...
	<div class="contact main-grid-border">
		<div class="container" style="margin-top:80px;">
			...
			<section id="hire">    
				<form id="filldetails" action="submitContact" method="post">
					  ...
					  <div class="field msg-box">
							<textarea id="msg" rows="4" name="query" placeholder="Your message goes here..."/></textarea>
							<label for="msg">Your Query</label>
							<span class="ss-icon">Query</span>
					  </div>
		...
		<input class="button" type="submit" value="Send" style="background: #01a185;
    color: white;
